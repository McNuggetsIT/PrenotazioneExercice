...
Firinu Anna: Creazione della classe Prenotazione. Alla classe prenotazione ho passato l'utente già creato, e ho aggiunto gli attributi privati data, ora e numero persone. Dopo aver definito i get e set ho definito i seguenti metodi:
